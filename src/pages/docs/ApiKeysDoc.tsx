...
export function ApiKeysDoc() {
  return (
    ...
    >
      ...
      <p>
        An API key is basically a{" "}
        <strong>password that lets an app talk to an AI service</strong>.
        LettuceAI itself does not run AI models, it connects you directly to a
        provider like OpenAI or Anthropic using your key.
      </p>
      <p>
        You can think of LettuceAI as the interface, and the API key as the
        permission that tells the provider "this user is allowed to send
        requests."
      </p>
      ...
      <p>
        No. You don't need to code or understand APIs. You just copy a key once
        and paste it into LettuceAI.
      </p>

      <DocHeading level={2}>Will this cost money?</DocHeading>
      <p>
        Most providers charge based on usage. For normal chatting, the cost is
        usually very small. You can always see usage and limits on the
        provider's dashboard.
      </p>

      <DocHeading level={2}>Are there free providers or free tiers?</DocHeading>
      <p>
        Sometimes. Some providers offer free trial credits, free-rate limited
        access, or a small free tier for certain models.
      </p>
      <p>
        But this changes often. A provider can change pricing, remove free
        access, add queues, or require billing setup at any time.
      </p>
      <ul>
        <li>Some providers are completely paid from the start</li>
        <li>Some offer temporary free credits for new accounts</li>
        <li>Some offer limited free usage with slower speeds or strict caps</li>
      </ul>

      <Callout type="warning" title="Do not assume a provider is free">
        Always check the provider's current pricing page or dashboard before
        using it heavily.
      </Callout>
      ...
      <p>
        Below are short, provider-specific instructions. All of them follow the
        same idea: create an account, generate a key once, then paste it into
        LettuceAI.
      </p>
      ...
      <ol>
        <li>
          Go to{" "}
          <a href="https://anannas.ai" target="_blank" rel="noreferrer">
            anannas.ai
          </a>
        </li>
        <li>Create an account</li>
      ...
      <ol>
        <li>
          Go to{" "}
          <a href="https://featherless.ai" target="_blank" rel="noreferrer">
            featherless.ai
          </a>
        </li>
        <li>Create an account</li>
      ...
      <ol>
        <li>
          Go to{" "}
          <a href="https://nano-gpt.com" target="_blank" rel="noreferrer">
            nano-gpt.com
          </a>
        </li>
        <li>Create an account</li>
      ...
      <ol>
        ...
        <li>
          Go to <strong>Settings → Providers</strong>
        </li>
        <li>
          Click <strong>Add Provider</strong> or the <strong>+ icon</strong> in
      ...
      <Callout type="warning" title="Security">
        Your API keys are stored locally on your device and sent directly to the
        provider.
      </Callout>
