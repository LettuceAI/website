...
export function CharactersDoc() {
  return (
    ...
    >
      ...
      >
        <p>
          The final screen controls how the character behaves and remembers
          things.
        </p>
        <ul>
          <li>
          ...
          <li>
            <strong>System prompt</strong>: Instructions that guide responses
          </li>
          <li>
            <strong>Memory mode</strong>
            <ul className="mt-2">
              <li>
                <strong>Manual</strong>: Only saved memories are kept
              </li>
              <li>
                <strong>Dynamic</strong>: Important details are remembered
                automatically
              </li>
            </ul>
          </li>
          <li>
            <strong>Default model</strong>: Used when starting new chats
          </li>
        </ul>
      </DocSplit>
