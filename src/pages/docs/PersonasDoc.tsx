  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          <strong>Design references (optional)</strong>: reference images plus a
          short visual note, so AI-generated images can depict your persona
          consistently
        </li>
      </ul>
      <p>
        You can build a persona by hand, or use the{" "}
        <strong>Smart Creator</strong> to draft one through a guided
        conversation. A persona avatar can be uploaded or generated by the AI.
      </p>
      ...
      <p>
        ...
        devices or share them with others, and imported back in the same
        format.
      </p>
      <ul>
        <li>
          <strong>UEC (Unified Entity Card)</strong>: the portable format for
          personas, used for both export and import
        </li>
        <li>
          Use UEC to move personas between LettuceAI installs. Importing a UEC
          persona creates a fresh local copy.
        </li>
      </ul>
