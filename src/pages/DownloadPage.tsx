...
export function DownloadPage() {
  ...
  const platforms = [
    ...
    },
    {
      ...
      status: "available" as const,
      description:
        "Available as AppImage, .deb, and .rpm for all major distros.",
    },
  ];
            ...
            {platforms.map((platform, index) => (
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                  ...
                  >
                    <platform.icon
                      className={`w-7 h-7 ${platform.status === "available" ? "text-primary" : "text-muted-foreground"}`}
                    />
                  </div>
                  ...
                  <div className="flex-1">
                    ...
                    {platform.status === "available" && !release.loading && (
                      <p className="text-xs text-muted-foreground/70 mt-1">
                        {platform.name === "Android" ? "1.2.0" : "1.0.0.beta.4"}
                        {" • "}
                          ...
                          release.downloads.android ? (
                            ...
                            <Button asChild variant="outline" className="gap-2">
                              <a
                                href={
                                  release.releaseUrl ||
                                  `https://github.com/LettuceAI/mobile-app/releases`
                                }
                                target="_blank"
                                rel="noopener noreferrer"
                              >
